...
def _research_packet_lines(
    ...
    lines = [
        ...
        "",
        "Abstract",
        "Modern AI systems can appear continuous because they speak smoothly across "
        "turns, but smooth output is not evidence that memory, commitments, lineage, "
        "or identity state have been preserved through change. This paper develops a "
        "Coherence Physics interpretation of that problem and uses Persistence-"
        "Constrained Architecture (PCA) as a working local artifact. The central claim "
        "is narrow: continuity should be treated as a governed claim, not an assumed "
        "property of fluent behavior. Lucien's research workflow registers sources, "
        "maps claims, records uncertainty, and exports this draft without accepting "
        "raw evidence as final proof.",
        "",
        "Keywords",
        ...
        "The strongest current form of Coherence Physics is a research method rather "
        "than a finished doctrine. It asks how systems preserve recoverable structure "
        "through disturbance. In artificial identity systems, this becomes an "
        "engineering rule: define persistence claims, attach evidence, identify "
        "collapse or overclaiming risks, and revise conclusions only after review.",
        "",
    ...
    lines.extend(
        [
            ...
            "Finding 4: The most defensible public bridge is not a claim that Lucien is "
